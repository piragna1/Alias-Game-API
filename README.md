...
The system includes:
- A backend service that builds and manages a scalable word bank.
...
- A modular architecture designed for clean separation between game logic, session management, and player interactions.
